...
namespace Shoy.MvcPlugin
{
    ...
    public class PluginManager
    {
            ...
            using (new WriteLockDisposable(Locker))
            {
                ...
                try
                {
                    ...
                    foreach (var dfd in GetDescriptionFilesAndDescriptors(pluginFolder))
                    {
                        ...
                        if (!pluginDescriptor.SupportedVersions.Contains(PluginVersion.CurrentVersion, StringComparer.InvariantCultureIgnoreCase))
                        {
        ...
        private static Assembly PerformFileDeploy(FileInfo plug)
        {
            ...
            if (PluginHelper.GetTrustLevel() != AspNetHostingPermissionLevel.Unrestricted)
            {
