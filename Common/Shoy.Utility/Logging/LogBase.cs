...
namespace Shoy.Utility.Logging
{
    public abstract class LogBase : ILog
    {
        ...
        {
            if (IsTraceEnabled)
                _write(LogLevel.Trace, string.Format(format, args));
        }
        ...
        {
            if (IsDebugEnabled)
                _write(LogLevel.Debug, string.Format(format, args));
        }
        ...
        {
            if (IsInfoEnabled)
                _write(LogLevel.Info, string.Format(format, args));
        }
        ...
        {
            if (IsWarnEnabled)
                _write(LogLevel.Warn, string.Format(format, args));
        }
        ...
        {
            if (IsErrorEnabled)
                _write(LogLevel.Error, string.Format(format, args));
        }
        ...
        {
            if (IsErrorEnabled)
                _write(LogLevel.Error, string.Format(format, args), exception);
        }
        ...
        {
            if (IsFatalEnabled)
                _write(LogLevel.Fatal, string.Format(format, args));
        }
        ...
        {
            if (IsFatalEnabled)
                _write(LogLevel.Fatal, string.Format(format, args), exception);
        }
