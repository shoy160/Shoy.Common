...
namespace Shoy.Wpf.Helper
{
    public class NativeHelper
    {
        ...
        /// <summary> Sets the layered window attributes. </summary>
        ...
        /// <summary> GetForegroundWindow API </summary>
        [DllImport("user32.dll")]
